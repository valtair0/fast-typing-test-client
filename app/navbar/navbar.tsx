  ...
  return (
    <div>
      <nav className="relative px-4 py-4 flex justify-between items-center ">
        ...
        <a
          className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 bg-gray-50 hover:bg-gray-400 text-sm text-gray-900 font-bold  rounded-xl transition duration-200"
          href="#"
        >
          Sign In
        </a>
        <a
          className="hidden lg:inline-block py-2 px-6 bg-gray-50 text-black hover:bg-gray-400 text-sm font-bold rounded-xl transition duration-200"
          href="#"
        >
          Sign up
        </a>
